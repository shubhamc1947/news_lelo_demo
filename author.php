        ...
        <div class="row">
            <div class="col-md-8">
                <?php 
                    ...
                    $sql5="select first_name,last_name from user where user_id={$authorid}";
                    $res5=mysqli_query($conn,$sql5) or die("author name fetch query failed");
                    $authorname=mysqli_fetch_assoc($res5);
                ?>
                <h3>Author : <?php echo $authorname['first_name']." ".$authorname['last_name']?></h3>
                <!-- post-container -->
